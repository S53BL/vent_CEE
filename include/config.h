...
// ============================================================
// Network - IP naslovi enot
// ============================================================
#define IP_CEE     "192.168.2.192"   // ta enota
#define IP_REW     "192.168.2.190"   // kontrolna enota (touch, wifi)
#define IP_UT_DEW  "192.168.2.193"   // display enota utility
#define IP_KOP_DEW "192.168.2.194"   // display enota kopalnica
#define IP_SEW1    "192.168.2.195"   // zunanja senzorska enota 1
#define IP_SEW2    "192.168.2.196"   // zunanja senzorska enota 2
#define IP_SEW3    "192.168.2.197"   // zunanja senzorska enota 3
#define IP_SEW4    "192.168.2.198"   // zunanja senzorska enota 4
#define IP_SEW5    "192.168.2.199"   // zunanja senzorska enota 5
